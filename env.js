 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.dashboard-app.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.dashboard-app'; // ios bundle id
const PACKAGE = 'com.dashboard-app'; // android package name
const NAME = 'dashboard-app'; // app name
const EXPO_ACCOUNT_OWNER = 'kwskicky'; // expo account owner
const EAS_PROJECT_ID = 'fd30fe4f-26cb-45fe-9660-7867b88f405a'; // eas project id
const SCHEME = 'dashboard-app'; // app scheme
...
const client = z.object({
  ...
  // API_URL: z.string(), // Commented out - not used, app uses Supabase directly
  VAR_NUMBER: z.number(),
  VAR_BOOL: z.boolean(),
...
const _clientEnv = {
  ...
  // API_URL: process.env.API_URL || 'http://localhost:8081', // Commented out - not used, app uses Supabase directly
  VAR_NUMBER: Number(process.env.VAR_NUMBER) || 123,
  VAR_BOOL: process.env.VAR_BOOL === 'true' || true,
  EXPO_PUBLIC_SUPABASE_URL:
    process.env.EXPO_PUBLIC_SUPABASE_URL ||
    'https://sktcnsxhpzqtkyajhywe.supabase.co',
